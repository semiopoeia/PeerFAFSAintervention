...
#5000 trees, interaction=1, shrinkage=0.05
#run boosting algorithm (note one will have to train parameters to find best model)
boost.red3=gbm(FAFSA_3_1_17~.,data=FAFSA3[train,],distribution="gaussian",n.trees=5000,
interaction.depth=1,cv.folds=10,shrinkage=.01)
#find which predictors are most influential on outcome
summary(boost.red3)
#create predicted values 
yhat=predict.gbm(boost.red3,newdata=FAFSA3[-train ,],n.trees =5000, type="response")
